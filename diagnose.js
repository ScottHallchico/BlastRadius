...
async function main() {
    console.log("Compiling latest engine...");
    require('child_process').execSync('npx tsc src/lib/mcp/engine.ts --esModuleInterop --ignoreConfig');
    ...
    console.log(`7. Time spent traversing: ${stats.timeTraversing.toFixed(2)} ms`);
    ...
    console.log(`9. Time spent building graph / regex regex matching: ${analysisTime.toFixed(2)} ms`);
